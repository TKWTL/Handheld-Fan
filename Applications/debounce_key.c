...
/*******************************用户按键配置区****************************************/
/***********************在这里编写按键状态获取函数*****************************/
inline uint8_t KEY_UP_GetIO(void) {
    return LL_GPIO_IsInputPinSet(K_UP_PORT, K_UP_PIN);
}
inline uint8_t KEY_DOWN_GetIO(void) {
    return LL_GPIO_IsInputPinSet(K_DOWN_PORT, K_DOWN_PIN);
}
inline uint8_t KEY_LEFT_GetIO(void) {
    return LL_GPIO_IsInputPinSet(K_LEFT_PORT, K_LEFT_PIN);
}
inline uint8_t KEY_RIGHT_GetIO(void) {
    return LL_GPIO_IsInputPinSet(K_RIGHT_PORT, K_RIGHT_PIN);
}
inline uint8_t KEY_CLICK_GetIO(void) {
    return LL_GPIO_IsInputPinSet(K_CLICK_PORT, K_CLICK_PIN);
}
...
const KeyInfo_t KeyInfo_Array[KeyIndex_Max] = {
    ...
    {120, 20, 100, 0, KEY_UP_GetIO},
    {120, 20, 100, 0, KEY_DOWN_GetIO},
    {120, 20, 100, 0, KEY_LEFT_GetIO},
    {120, 20, 100, 0, KEY_RIGHT_GetIO},
    {120, 20, 100, 0, KEY_CLICK_GetIO},
};
